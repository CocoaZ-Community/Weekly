...
#### [Ulysses 付费策略改为订阅制度](https://ulyssesapp.com/blog/2017/08/ulysses-switches-to-subscription/)

> Ulysses 是一款面向 Mac、iPhone、iPad 的一站式 Markdown 写作应用。

Ulysses 也全面转向订阅制度，订阅用户可以在全平台使用，而不用再去购买单独购买各个平台的版本。订阅价格 ¥218 一年，之前购买老用户享有 ¥163/年的终身折扣订阅价格。（10 月 31 日前购买）另外，还增加了 14 天的全功能试用。*@少数派sspai*
